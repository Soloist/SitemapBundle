                ...
                ->prototype('array')
                    ->children()
                        ...
                        ->arrayNode('routes')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('html')->defaultValue('soloist_sitemap_show')->end()
                                ->scalarNode('xml')->defaultValue('soloist_sitemap_show_xml')->end()
                            ->end()
                        ->end()
                        ...
                        ->arrayNode('root')
                            ...
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('updated_at')->defaultNull()->end()
                                ->scalarNode('change_frequency')->defaultNull()->end()
